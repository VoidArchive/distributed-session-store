...
const (
	SessionService_Set_FullMethodName       = "/session.SessionService/Set"
	...
	SessionService_Replicate_FullMethodName = "/session.SessionService/Replicate"
)
...
type SessionServiceClient interface {
	...
	Replicate(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ReplicationLog, ReplicationAck], error)
}
...
func (c *sessionServiceClient) Set(ctx context.Context, in *SetRequest, opts ...grpc.CallOption) (*SetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetResponse)
	err := c.cc.Invoke(ctx, SessionService_Set_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sessionServiceClient) Replicate(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ReplicationLog, ReplicationAck], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &SessionService_ServiceDesc.Streams[0], SessionService_Replicate_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ReplicationLog, ReplicationAck]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type SessionService_ReplicateClient = grpc.BidiStreamingClient[ReplicationLog, ReplicationAck]
...
type SessionServiceServer interface {
	...
	Replicate(grpc.BidiStreamingServer[ReplicationLog, ReplicationAck]) error
...
func (UnimplementedSessionServiceServer) Set(context.Context, *SetRequest) (*SetResponse, error) {
...
func (UnimplementedSessionServiceServer) Replicate(grpc.BidiStreamingServer[ReplicationLog, ReplicationAck]) error {
...
func _SessionService_Set_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetRequest)
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SessionService_Set_FullMethodName,
	}
...
func _SessionService_Replicate_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(SessionServiceServer).Replicate(&grpc.GenericServerStream[ReplicationLog, ReplicationAck]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type SessionService_ReplicateServer = grpc.BidiStreamingServer[ReplicationLog, ReplicationAck]
...
var SessionService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Set",
			Handler:    _SessionService_Set_Handler,
		},
		{
			MethodName: "Get",
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _SessionService_Replicate_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
